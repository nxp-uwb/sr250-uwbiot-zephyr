 ...
 */
#define DEMO_RNG_CONTROLEE_TASK_STACK_SIZE 1200
#else
#define DEMO_RNG_CONTROLEE_TASK_STACK_SIZE 400
...
#define DEMO_RANGING_CONTROLEE_TASK_SIZE DEMO_RNG_CONTROLEE_TASK_STACK_SIZE
...
static const uint8_t gkDeviceMacAddr[] = {RANGING_APP_MAC_ADDR_CLEE};
static const uint8_t gkDstMacAddr[]    = {RANGING_APP_MAC_ADDR_CTRL};
...
UWBOSAL_TASK_HANDLE uwb_demo_start(void)
{
    ...
    UWBIOT_STACK_DEFINE(DemoRngCntlee_stack, DEMO_RANGING_CONTROLEE_TASK_SIZE);
...
#if UWBIOT_OS_ZEPHYR
    threadparams.pStack     = (k_thread_stack_t *)&DemoRngCntlee_stack;
    threadparams.stackdepth = UWBIOT_THREAD_STACK_SIZE(DemoRngCntlee_stack);
#else
